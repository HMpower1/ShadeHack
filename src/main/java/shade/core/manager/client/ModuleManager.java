...
import shade.gui.clickui.ClickGUI;
import shade.gui.font.FontRenderers;
import shade.features.hud.HudElement;
import shade.features.hud.impl.*;
import shade.features.modules.Module;
import shade.features.modules.client.*;
import shade.features.modules.combat.*;
import shade.features.modules.misc.*;
import shade.features.modules.movement.Timer;
import shade.features.modules.movement.*;
import shade.features.modules.player.*;
import shade.features.modules.render.Particles;
import shade.features.modules.render.*;
...
public class ModuleManager implements IManager {
    ...
    public void onLoad(String category) {
        try {
            Shade.EVENT_BUS.unsubscribe(unHook);
