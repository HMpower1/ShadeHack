...
import shade.core.hooks.ManagerShutdownHook;
import shade.core.hooks.ModuleShutdownHook;
...
public class Shade implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BUILD_DATE = ExoUtility.readManifestField("Build-Timestamp");
        GITHUB_HASH = ExoUtility.readManifestField("Git-Commit");
        ExoUtility.syncVersion();

        EVENT_BUS.registerLambdaFactory("shade",
        ...
        LOGGER.info("[Shade] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
