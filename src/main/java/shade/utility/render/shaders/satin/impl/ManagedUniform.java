 ...
 */
package shade.utility.render.shaders.satin.impl;

import shade.utility.render.shaders.satin.api.managed.uniform.Uniform1f;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform1i;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform2f;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform2i;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform3f;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform3i;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform4f;
import shade.utility.render.shaders.satin.api.managed.uniform.Uniform4i;
import shade.utility.render.shaders.satin.api.managed.uniform.UniformMat4;
