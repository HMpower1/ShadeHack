package shade.utility.render.shaders;
...
import shade.utility.render.WindowResizeCallback;
import shade.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import shade.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import shade.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("shade", "blur"), VertexFormats.POSITION);
