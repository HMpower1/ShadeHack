...
public class WayPointCommand extends Command {
    ...
    public void executeBuild(@NotNull LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(literal("list").executes(context -> {
            sendMessage(isPl() ? "Waypointy:" : "Waypoints:");
        ...
        builder.then(literal("remove").then(arg("name", WayPointArgumentType.create()).executes(context -> {
            ...
            sendMessage(isPl() ? "Usunieto waypoint " : "Deleted waypoint " + wp.getName());
        ...
        builder.then(literal("add").then(arg("name", StringArgumentType.word()).executes(context -> {
            ...
            sendMessage((isPl() ? "Dodano waypoint " + name + " z koordynatami" : "Added waypoint " + name + " with coords") + " X: " + ((int) mc.player.getX()) + " Y: " + ((int) mc.player.getY()) + " Z: " + ((int) mc.player.getZ()));
            ...
            return SINGLE_SUCCESS;
                ...
                .then(arg("y", IntegerArgumentType.integer())
                        .then(arg("z", IntegerArgumentType.integer()).executes(context -> {
                            ...
                            sendMessage((isPl() ? "Dodano waypoint " + name + " z koordynatami X: " : "Added waypoint " + name + " with coords") + pos.getX() + " Y: " + pos.getY() + " Z: " + pos.getZ());
