...
import shade.features.cmd.args.SettingArgumentType;
...
import shade.setting.impl.EnumConverter;
import shade.setting.impl.PositionSetting;
                    ...
                    return SINGLE_SUCCESS;
                        ...
                        .then(arg("settingValue", StringArgumentType.greedyString()).executes(context -> {
                            ...
                            if (setting.getValue().getClass().getSimpleName().equalsIgnoreCase("String")) {
                                ...
                                sendMessage(Formatting.DARK_GRAY + module.getName() + " " + setting.getName() + (isPl() ? " ustawiono na " : " has been set to ") + settingValue);
                                return SINGLE_SUCCESS;
                            }
                            ...
                            try {
                                ...
                                sendMessage((isPl() ? "Niepoprawna wartosc! To ustawienie wymaga typu: " : "Bad Value! This setting requires a: ") + setting.getValue().getClass().getSimpleName());
                                return SINGLE_SUCCESS;
                            }

                            if(settingValue.contains("toggle"))
                                sendMessage(Formatting.GRAY + module.getName() + " " + setting.getName() + (isPl() ? " zostal przelaczony" : " has been toggled"));
                            else
                                sendMessage(Formatting.GRAY + module.getName() + " " + setting.getName() + (isPl() ? " ustawiono na " : " has been set to ") + settingValue);
