...
public class DrawCommand extends Command {
    ...
    public void executeBuild(@NotNull LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(arg("module", ModuleArgumentType.create()).executes(context -> {
            ...
            if(ClientSettings.isPl()){
                sendMessage("Modul " + Formatting.GREEN + module.getName() + Formatting.WHITE + " jest teraz " + (module.isDrawn() ? "widoczny w ArrayList" : "PL widoczny w ArrayList"));
            } else {
