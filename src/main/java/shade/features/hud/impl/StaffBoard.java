...
import shade.features.cmd.impl.StaffCommand;
...
public class StaffBoard extends HudElement {
    ...
    public static boolean check(String name) {
        if (mc.getCurrentServerEntry() != null && mc.getCurrentServerEntry().address.contains("mcfunny")) {
            return name.contains("helper") || name.contains("moder") || name.contains("PL") || name.contains("PL");
        }
        return name.contains("helper") || name.contains("moder") || name.contains("admin") || name.contains("owner") || name.contains("curator") || name.contains("PL") || name.contains("PL") || name.contains("PL") || name.contains("PL") || name.contains("PL") || name.contains("PL") || name.contains("PL") || name.contains("PL");
    }
