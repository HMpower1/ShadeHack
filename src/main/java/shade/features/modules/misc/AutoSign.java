...
import shade.events.impl.EventScreen;
import shade.injection.accesors.ISignEditScreen;
...
public class AutoSign extends Module {
    ...
    public String format(String s) {
        ...
        try {
            ...
            sendMessage(Formatting.RED + (isPl() ? "PL PL PL PL PL PL!" : "Your date format is wrong!"));
        }
