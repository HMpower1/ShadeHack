...
import shade.events.impl.EventAttackBlock;
import shade.events.impl.EventSetBlockState;
...
import shade.features.modules.player.SpeedMine;
...
public class Nuker extends Module {
    ...
    public void onEnable() {
        ...
        nukerThread.setName("Shade-NukerThread");
    ...
    public void onBlockInteract(EventAttackBlock e) {
        ...
        if (blocks.getValue().equals(BlockSelection.Select) && targetBlockType != mc.world.getBlockState(e.getBlockPos()).getBlock()) {
            ...
            sendMessage(isPl() ? "Wybrany blok: " + Formatting.AQUA + targetBlockType.getName().getString() : "Selected block: " + Formatting.AQUA + targetBlockType.getName().getString());
        }
    }
