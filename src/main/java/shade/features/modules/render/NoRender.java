...
public class NoRender extends Module {
    ...
    public final Setting<Boolean> disableGuiBackGround = new Setting<>("noGuiBackGround", false);
    ...
    public void onSync(EventSync e) {
        ...
        if (auto.getValue()) {
            if (arrowCounter > 64)
                Managers.NOTIFICATION.publicity("NoRender", isPl() ? "PL PL PL! PL..." : "Arrows limit reached! Removing...", 3, Notification.Type.SUCCESS);

            if (itemsCounter > 16)
                Managers.NOTIFICATION.publicity("NoRender", isPl() ? "PL PL PL! PL..." : "Item limit reached! Removing...", 3, Notification.Type.SUCCESS);

            if (xpCounter > 16)
                Managers.NOTIFICATION.publicity("NoRender", isPl() ? "PL PL PL PL! PL..." : "XP orbs limit reached! Removing...", 3, Notification.Type.SUCCESS);

            if (potionCouter > 8)
                Managers.NOTIFICATION.publicity("NoRender", isPl() ? "PL PL PL! PL..." : "Potions limit reached! Removing...", 3, Notification.Type.SUCCESS);
