...
import shade.Shade;
import shade.events.impl.EventKeyboardInput;
import shade.events.impl.EventMove;
import shade.events.impl.EventPlayerJump;
import shade.events.impl.EventPlayerTravel;
...
public class HoleSnap extends Module {
    ...
    public void onEnable() {
        ...
        if (useTimer.getValue()) {
            Shade.TICK_TIMER = timerValue.getValue();
        }
    }
    ...
    public void onUpdate() {
        if (onDeath.getValue() && mc.player != null
            ...
            disable(isPl() ? "Umarles! Wylaczam..." : "You died! Disabling...");
        if (mc.player != null && mc.player.getBlockPos().equals(hole) && onInHole.getValue())
            disable(isPl() ? "Jestes juz w dziurze! Wylaczam.." : "You're in a hole already! Disabling..");
    }
    ...
    private @Nullable BlockPos findHole() {
        ...
        if (fbp == null && onNoHoleFound.getValue())
            disable(isPl() ? "Nie znaleziono dziury! Wylaczam..." : "Hole not found! Disabling...");
