...
public class MainMenuScreen extends Screen {
    ...
    protected MainMenuScreen() {
        super(Text.of("ShadeMainMenuScreen"));
        INSTANCE = this;
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.thglitchBig.drawCenteredString(context.getMatrices(), "SHADE", (int) (halfOfWidth), (int) (halfOfHeight - 120), new Color(255, 255, 255, hoveredLogo ? 230 : 180).getRGB());
        ...
        int offsetY = 10;
        for (String change : ExoUtility.changeLog) {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (Render2DEngine.isHovered(mouseX, mouseY, (int) (halfOfWidth - 157), (int) (halfOfHeight - 140), 300, 70))
            Util.getOperatingSystem().open(URI.create("https://shade-site.vercel.app/"));
