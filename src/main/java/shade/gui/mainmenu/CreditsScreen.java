...
public class CreditsScreen extends Screen {
    ...
    protected CreditsScreen() {
        ...
        INSTANCE = this;
        for (String line : Shade.contributors) {
            if (line == null)
                continue;
            ...
            CreditsScreen.getInstance().contributors.add(new CreditsScreen.Contributor(name, CreditsScreen.getAvatar(avatar), role, description.replace('\t', '\n'), clickAction));
        }
    }
