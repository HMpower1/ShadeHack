package shade.gui.windows.impl;
...
import shade.gui.clickui.impl.SliderElement;
import shade.gui.font.FontRenderers;
import shade.gui.windows.WindowBase;
...
public class WaypointWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        if (waypointPlates.isEmpty()) {
            FontRenderers.sf_medium.drawCenteredString(context.getMatrices(), isPl() ? "Tutaj na razie jest pusto" : "It's empty here yet",
