...
public class WindowsScreen extends Screen {
    ...
    private static final Identifier clickGuiIcon = Identifier.of("shade", "textures/gui/elements/clickgui.png");

    public WindowsScreen(WindowBase... windows) {
        super(Text.of("ShadeWindows"));
        this.windows.clear();
