...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        boolean dark = Render2DEngine.isDark(Shade.copy_color);
        ...
        FontRenderers.sf_medium_mini.drawString(matrixStack, "Copy", x + 13, y + 56.5f, copyHovered ? new Color(0xA3FFFFFF, true).getRGB() : Color.WHITE.getRGB());
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, Shade.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) Shade.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(Shade.copy_color.getRGB());
